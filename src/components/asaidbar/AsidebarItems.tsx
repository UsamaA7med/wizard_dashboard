    ...
    <div className="px-[16px] flex-1">
      <ul className="flex flex-col gap-[8px]">
        <li>
          ...
          >
            <img src="DashboardIcon.png" className="w-[18px] h-[18px] shrink-0" />
        ...
        <li>
          <a
            ...
            className="px-[24px] text-[#CBC3D7] py-[12px] h-[44px] gap-[16px] flex items-center text-[14px] font-semibold rounded-[8px]"
          >
            <img src="ElixirsIcon.png" className="w-[18.06px] h-[18px] shrink-0" />
            <span>Elixirs</span>
          </a>
        </li>
        <li>
          <a
            ...
            className="px-[24px] text-[#CBC3D7] py-[12px] h-[44px] gap-[16px] flex items-center text-[14px] font-semibold rounded-[8px]"
          >
            <img src="ArchivesIcon.png" className="w-[22px] h-[19.5px] shrink-0" />
            <span>Archives</span>
          </a>
        </li>
      </ul>
