  ...
  return (
    <div className="flex items-center gap-[8px]">
      <button
        ...
        disabled={page === 1}
        className={`disabled:opacity-40 p-[8px] text-[18px] w-[23.4px] h-[28px] flex justify-center items-center ${page !== totalPages && 'text-[#D0BCFF]'} ${page !== 1 && 'cursor-pointer'}`}
      >
      ...
      <button
        ...
        className={`disabled:opacity-40 p-[8px] text-[18px] w-[23.4px] h-[28px] flex justify-center items-center ${page !== totalPages && 'text-[#D0BCFF] cursor-pointer'}`}
      >
